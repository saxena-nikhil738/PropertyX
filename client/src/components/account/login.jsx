...
const Login = ({ endpoint }) => {
  ...
  let toogle;
  if (endpoint === "buyerlogin") toogle = 1;
  if (endpoint === "sellerlogin") toogle = 0;
      ...
      <div className="form">
        ...
        <div className="switch-account">
          <div className="signup-login">
            <div className="exist">
              <Link className="login-link" to="/buyersignup">
                Create Account?
              </Link>
            </div>
          </div>
          {toogle ? (
            <Link className="admin-login" to="/sellerlogin">
              Seller login
            </Link>
          ) : (
            <Link className="admin-login" to="/buyerlogin">
              Buyer login
            </Link>
          )}
        </div>
